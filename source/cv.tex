...
% during their initial term, helping them in acculturation process,
...
\raisebox{-3pt}{\Mobilefone} & +1 503 964 9406 \\ % Phone number
\raisebox{-1pt}{\Letter} & \href{mailto:dhara@sheth.net.in}{dhara@sheth.net.in} \\ % Email address
\Keyboard & \href{http://shethdhara.weebly.com}{http://shethdhara.weebly.com} \\ % Website
\raisebox{-4pt}{\textifsymbol{18}} & \#619, 1717 SW Park Ave, Portland, OR 97201 \\ % Address
\end{tabular}
}
}\\[10pt]
...
\\
$\triangleright$ World Mental Health Week - Creating awareness \\
\\
